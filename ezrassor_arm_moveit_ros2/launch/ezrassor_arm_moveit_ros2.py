...
def generate_launch_description():
    ...
    info_launch_arg = DeclareLaunchArgument(
        "info", default_value=debug_launch_arg
    )
            ...
            trajectory_execution_launch_include = GroupAction(
                actions=[
                    ...
                    IncludeLaunchDescription(
                        ...
                        moveit_manage_controllers_launch_arg = DeclareLaunchArgument(
                            "moveit_manage_controllers",
                            default_value="true"
                        ),
                        moveit_controller_manager_launch_arg = DeclareLaunchArgument(
    ...
    if LaunchConfiguration("allow_trajectory_execution") == "true":
        sensor_manager_launch_include = GroupAction(
            actions=[
                ...
                IncludeLaunchDescription(
                    ...
                    moveit_sensor_manager_launch_arg = DeclareLaunchArgument(
        ...
        move_group_node = Node(
            ...
            name='move_group',
            launch_prefix_launch_arg='launch_prefix',
            respawn='false',
            output='screen',
            arguments=LaunchConfiguration("command_args"),
            #env=
            parameters=[{
