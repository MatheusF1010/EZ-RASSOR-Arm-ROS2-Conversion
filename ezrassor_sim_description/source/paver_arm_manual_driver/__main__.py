...
FIRST_JOINT_INTERNAL_TOPIC = "joint_1_velocity_controller/commands"
SECOND_JOINT_EXTERNAL_TOPIC = "joint_2_action"
SECOND_JOINT_INTERNAL_TOPIC = "joint_2_velocity_controller/commands"
THIRD_JOINT_EXTERNAL_TOPIC = "joint_3_action"
THIRD_JOINT_INTERNAL_TOPIC = "joint_3_velocity_controller/commands"
FOURTH_JOINT_EXTERNAL_TOPIC = "joint_4_action"
FOURTH_JOINT_INTERNAL_TOPIC = "joint_4_velocity_controller/commands"
...
def handle_partial_autonomy_movements(data):
    ...
    partial_autonomy_msg = JointTrajectoryPoint()
...
def main(passed_args=None):
    ...
    try:
        ...
        publishers[PARTIAL_AUTONOMY_INTERNAL_TOPIC] = node.create_publisher(
            JointTrajectoryPoint, PARTIAL_AUTONOMY_INTERNAL_TOPIC, QUEUE_SIZE
        )
